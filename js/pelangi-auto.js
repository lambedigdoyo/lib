...
(function () {
    ...
    for (B = H.length; l < B; ++l)(function () {
      ...
      g.src = "https://cdn.jsdelivr.net/gh/lambedigdoyo/lib@master/js/lang-" + encodeURIComponent(H[l]) + ".js";
      N.insertBefore(g, N.firstChild)
    })(H[l]);
    for (var S = H.length, F = [], l = 0, B = P.length; l < B; ++l) F.push("https://cdn.jsdelivr.net/gh/lambedigdoyo/lib@master/css/skins/" + encodeURIComponent(P[l]) + ".css");
    F.push("https://cdn.jsdelivr.net/gh/lambedigdoyo/lib@master/css/grPelangi-G30S23.css"); 
    (function (g) {
      function r(l) {
        if (l !== x) {
    ...
    var ca = function () {
      ...
      (function () {
        ...
        var U = Q.PR = {
              ...
              function f() {
                for (var c = Q.PR_SHOULD_USE_CONTINUATION ? b.now() + 250 : Infinity; t < r.length && b.now() < c; t++) {
                  for (var d = r[t], k = h, n = d; n = n.previousSibling;) {
                    ...
                    if (l ? !/^\??pelangi\b/.test(l) : 3 !== q || /\S/.test(n.nodeValue)) break;
                    if (l) {
                      k = {};
          ...
          R = Q.define;
        "function" === typeof R && R.amd && R("pelangi", [], function () {
          return U
        })
      })();
      return g
